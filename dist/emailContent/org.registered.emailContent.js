...
exports.orgRegisteredEmail = void 0;
const template_1 = __importDefault(require("../view/email/template"));
const orgRegisteredEmail = (title, verificationToken) => __awaiter(void 0, void 0, void 0, function* () {
    let emailContent = template_1.default.replace("{{name}}", title);
    ...
    emailContent = emailContent.replace("{{link}}", `${Object(process.env).FRONTEND}/org/verify-email/${verificationToken}`);
...
exports.orgRegisteredEmail = orgRegisteredEmail;
